 ...
 */
export function BrewTagShell({ children }: { children: ReactNode }) {
  return (
    <div className="font-brew-sans min-h-screen text-[#4a2800] relative overflow-x-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(255,245,200,0.35) 0%, transparent 100%)",
        }}
      />
      <div
        aria-hidden
        ...
        style={{
          background:
            "linear-gradient(-90deg, rgba(255,238,185,0.25) 0%, transparent 100%)",
        }}
      />
      <div
        aria-hidden
